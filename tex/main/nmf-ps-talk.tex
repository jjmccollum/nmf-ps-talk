...
\begin{document}
	...
	\begin{frame}{The Quantitative Method}
		\begin{itemize}
			...
			\begin{itemize}
				\item $\geq 70\%$ with one another, and $10\%$ more than with others
			\end{itemize}
		\end{itemize}
		\begin{center}
			\begin{tikzpicture}
	...
	\begin{frame}{Non-negative Matrix Factorization}
		\begin{itemize}
			\item ``High-fidelity data compression''; reconstruct the original data...
			\begin{center}
				\begin{tikzpicture}
					%Readings-MSS graph:
					%Readings:
					\path
						(0.0, 6) node[shape=circle, fill=blue!60, scale=1.0 ](rm_r1) {}
						(0.6666, 6) node[shape=circle, fill=blue!60, scale=1.0 ](rm_r2) {}
						(1.3333, 6) node[shape=circle, fill=blue!60, scale=1.0 ](rm_r3) {}
						(2.0, 6) node[shape=circle, fill=blue!60, scale=1.0 ](rm_r4) {}
						(2.6666, 6) node[shape=circle, fill=blue!60, scale=1.0 ](rm_r5) {}
						(3.3333, 6) node[shape=circle, fill=blue!60, scale=1.0 ](rm_r6) {}
						(4.0, 6) node[shape=circle, fill=blue!60, scale=1.0 ](rm_r7) {};
					%MSS:
					\path
						(0.0, 4) node[shape=circle, fill=red!60, scale=1.0 ](rm_m1) {}
						(1.3333, 4) node[shape=circle, fill=red!60, scale=1.0 ](rm_m2) {}
						(2.6666, 4) node[shape=circle, fill=red!60, scale=1.0 ](rm_m3) {}
						(4.0, 4) node[shape=circle, fill=red!60, scale=1.0 ](rm_m4) {};
					%Edges:
					...
					%Labels:
					\draw 
						(6.0, 6) node[text width=1in, align=left] (rtm_rl) {\footnotesize Readings}
						(6.0, 4) node[text width=1in, align=left] (rtm_ml) {\footnotesize Manuscripts};
				\end{tikzpicture}
			\end{center}
			...
			\begin{center}
				...
				%Labels:
				\draw 
					(6.0, 2) node[text width=1in, align=left] (rtm_rl) {\footnotesize Readings}
					(6.0, 1) node[text width=1in, align=left] (rtm_tl) {\footnotesize Profiles}
					(6.0, 0) node[text width=1in, align=left] (rtm_ml) {\footnotesize Manuscripts};
				\end{tikzpicture}
			\end{center}
			\item A ``sum of parts'' model that is robust to mixture
		\end{itemize}
	\end{frame}
	\begin{frame}{Non-negative Matrix Factorization}
		\begin{itemize}
	...
	\begin{frame}{Results: John 18}
		\begin{itemize}
			...
			\item ``Primary readings'' vs. ``Secondary readings'' in profiles
	...
	\begin{frame}{Concluding Observations}
		\begin{itemize}
			\item The advantage: few assumptions are required
